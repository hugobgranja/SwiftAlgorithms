...
final class CLRSRBTTests: XCTestCase {
    
    var bst: CLRSRBT<Int, String>!
    ...
    func testInorderIterator() {
        ...
        let it = CLRSRBTInorderIterator<Int, String>(bst)
    ...
    func testPreorderIterator() {
        let values = [5,6,7,8,21,2,1,12]
        values.forEach { bst.put(key: $0, value: String($0)) }
        let it = CLRSRBTPreorderIterator<Int, String>(bst)
    ...
    func testPostorderIterator() {
        let values = [5,6,7,8,21,2,1,12]
        values.forEach { bst.put(key: $0, value: String($0)) }
        let it = CLRSRBTPostorderIterator<Int, String>(bst)
    ...
    func testLevelIterator() {
        let values = [5,6,7,8,21,2,1,12]
        values.forEach { bst.put(key: $0, value: String($0)) }
        let it = CLRSRBTLevelIterator<Int, String>(bst)
    ...
    func testCLRSRBT() {
        ...
        for _ in 0..<size {
            ...
            XCTAssertTrue(bst.isColorConsistent())
