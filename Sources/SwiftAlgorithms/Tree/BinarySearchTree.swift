...
public class BinarySearchTree<Key, Value>: BinaryTree where Key: Comparable {
...
public struct BinarySearchTreeInorderIterator<Key,Value>: IteratorProtocol where Key: Comparable {
    
    private let queue: LinkedListQueue<Key>
    
    public init(_ bst: BinarySearchTree<Key,Value>) {
...
public struct BinarySearchTreePreorderIterator<Key,Value>: IteratorProtocol where Key: Comparable {
...
public struct BinarySearchTreePostorderIterator<Key,Value>: IteratorProtocol where Key: Comparable {
